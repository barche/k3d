...
{
public:
	typedef boost::signals2::signal<bool(const point3&, point3&)>::slot_type position_slot_t;
	typedef boost::signals2::signal<bool(const point3&, vector3&, vector3&)>::slot_type orientation_slot_t;
